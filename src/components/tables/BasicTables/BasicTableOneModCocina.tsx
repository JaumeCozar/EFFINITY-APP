...
/>
    ...
    <div className="flex justify-end gap-2 w-full">
      <div className="flex flex-1 items-center justify-center rounded-full px-4 py-2 text-sm font-medium border border-gray-300 bg-white hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.05]">
        <button
          type="button"
          onClick={(e) => {
            e.stopPropagation();
          ...
          className="text-gray-950 dark:text-gray-400"
          title="Editar"
        >
          <svg
      ...
      <div className="rounded-full px-4 py-2 text-sm font-medium border border-red-300 bg-white hover:bg-red-50 text-red-600 dark:border-red-700 dark:bg-gray-800 dark:hover:bg-white/[0.05]">
        <button
          type="button"
          onClick={(e) => {
            e.stopPropagation();
  ...
  >
    ...
    <div className="flex flex-1 items-center justify-center rounded-full px-4 py-2 text-sm font-medium border border-gray-300 bg-white hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.05]">
      ...
      >
        ...
        <div className="flex flex-1 justify-center rounded-full px-4 py-2 text-sm font-medium border border-red-300 bg-white hover:bg-red-50 text-red-600 dark:border-red-700 dark:bg-gray-800 dark:hover:bg-white/[0.05]">
